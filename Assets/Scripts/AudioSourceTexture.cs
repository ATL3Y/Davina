...
public class AudioSourceTexture : MonoBehaviour
{
    ...
    void GetCurWave()
    {
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            pixels[i].r = pixels[i].r * .8f + samples[0][(int)(i * 4) + 0] * 128;
            pixels[i].g = pixels[i].g * .8f + samples[0][(int)(i * 4) + 1] * 128;
            pixels[i].b = pixels[i].b * .8f + samples[0][(int)(i * 4) + 2] * 128;
            pixels[i].a = pixels[i].a * .8f + samples[0][(int)(i * 4) + 3] * 128;
